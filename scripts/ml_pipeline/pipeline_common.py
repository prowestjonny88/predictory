...
def add_common_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--models-dir", default="models", help="Primary model artifact directory")
    parser.add_argument("--backend-models-dir", default="backend/models", help="Backend model drop-in directory")
    parser.add_argument("--exports-dir", default="exports", help="Export artifact directory")
